...
//		CreateFileUtil.createFile("Student", "", conn, "utf-8");
        Connection conn = DriverManager.getConnection("jdbc:mysql://rds6fbqrf6fbqrf.mysql.rds.aliyuncs.com:3306/credit_badasset_00", "za_dev_cbs", "za_dev_cbs_4b6299");
        DB_PREFIX = "";
        NAMESPACE_prefix = "com.tourstock.marketing.dao";
...
//		
        // fileDir = "sys";
        realTableName="za_bad_asset_biz_task";
        // CreateMyBatisFileUtil.createFile("bad_asset_biz_task", "", conn, "utf-8");
